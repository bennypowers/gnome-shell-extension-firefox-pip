...
export function icalcomponent_foreach_recurrence(
    comp: component,
    start?: any | null,
    end?: any | null,
    callback?: any | null,
...
export function icaldurationtype_as_ical_string(d?: any | null): string;
export function icaldurationtype_as_ical_string_r(d?: any | null): string;
...
export function icalparser_string_line_generator(out: string, buf_size: number, d?: any | null): string;
export function icalperiodtype_as_ical_string(p?: any | null): string;
export function icalperiodtype_as_ical_string_r(p?: any | null): string;
...
export function icalproperty_recurrence_is_excluded(
    comp: component,
    dtstart?: any | null,
    recurtime?: any | null
): number;
...
export function icalrecurrencetype_as_string(recur?: any | null): string;
export function icalrecurrencetype_as_string_r(recur?: any | null): string;
...
export function icalreqstattype_as_string_r(arg0?: any | null): string;
...
export function icaltime_as_ical_string_r(tt?: any | null): string;
...
export function icaltime_normalize(t?: any | null): any | null;
...
export function icaltimezone_truncate_vtimezone(
    vtz: component,
    start: timetype,
    end: timetype,
...
export function print_date_to_string(str: string, data?: any | null): void;
export function print_datetime_to_string(str: string, data?: any | null): void;
...
export function sspm_parse_mime(
    parts: any | null,
    max_parts: number,
    actions?: any | null,
    get_string?: any | null,
...
export function sspm_write_mime(parts: any | null, num_parts: number, output_string: string, header: string): number;
export type icalattach_free_fn_t = (data: string) => void;
export type icalparser_line_gen_func = (s: string, size: number, d?: any | null) => string;
export type pvl_applyf = (a?: any | null, b?: any | null) => void;
export type pvl_comparef = (a?: any | null, b?: any | null) => number;
export type pvl_findf = (a?: any | null, b?: any | null) => number;
...
export class datetimeperiodtype {
    ...
    constructor(copy: datetimeperiodtype);
...
export class sspm_action_map {
    ...
    constructor(copy: sspm_action_map);
...
export class timezonephase {
    ...
    constructor(copy: timezonephase);
